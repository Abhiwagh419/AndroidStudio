...
public final class SplashActivityBinding implements ViewBinding {
  ...
  private SplashActivityBinding(@NonNull RelativeLayout rootView, @NonNull TextView appName) {
  ...
  public static SplashActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SplashActivityBinding((RelativeLayout) rootView, appName);
    }
