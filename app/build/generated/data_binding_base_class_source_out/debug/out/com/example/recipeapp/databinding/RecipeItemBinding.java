...
public final class RecipeItemBinding implements ViewBinding {
  ...
  private RecipeItemBinding(@NonNull LinearLayout rootView, @NonNull TextView recipeDesc,
  ...
  public static RecipeItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RecipeItemBinding((LinearLayout) rootView, recipeDesc, recipeName);
    }
