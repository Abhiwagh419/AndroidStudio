...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull LinearLayout rootView, @NonNull EditText email,
      @NonNull TextView forgot, @NonNull Button loginBtn, @NonNull EditText password,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((LinearLayout) rootView, email, forgot, loginBtn, password,
          signup);
    }
