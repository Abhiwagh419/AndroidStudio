...
public final class ActivityForgotPasswordBinding implements ViewBinding {
  ...
  private ActivityForgotPasswordBinding(@NonNull LinearLayout rootView, @NonNull Button resetBtn) {
  ...
  public static ActivityForgotPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityForgotPasswordBinding((LinearLayout) rootView, resetBtn);
    }
