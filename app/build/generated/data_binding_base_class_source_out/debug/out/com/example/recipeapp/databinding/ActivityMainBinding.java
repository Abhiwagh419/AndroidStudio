...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView recipeRecycler;

  @NonNull
  public final Toolbar toolbar;

  private ActivityMainBinding(@NonNull DrawerLayout rootView, @NonNull DrawerLayout drawerLayout,
      @NonNull NavigationView navigationView, @NonNull RecyclerView recipeRecycler,
      @NonNull Toolbar toolbar) {
    this.rootView = rootView;
    this.drawerLayout = drawerLayout;
    this.navigationView = navigationView;
    this.recipeRecycler = recipeRecycler;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.recipeRecycler;
      RecyclerView recipeRecycler = ViewBindings.findChildViewById(rootView, id);
